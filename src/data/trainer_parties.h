...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FAINT_ATTACK, MOVE_FLAMETHROWER, MOVE_TAUNT, MOVE_SUNNY_DAY}
    },
    {
    .iv = 255,
    .lvl = 52,
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .species = SPECIES_MAWILE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BRICK_BREAK, MOVE_POISON_FANG, MOVE_CRUNCH, MOVE_SHADOW_BALL}
    },
    {
    .iv = 250,
    .lvl = 48,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_LEECH_LIFE, MOVE_THIEF, MOVE_GRUDGE}
    },
    {
    .iv = 250,
    .lvl = 47,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PAIN_SPLIT, MOVE_PSYBEAM, MOVE_MEAN_LOOK, MOVE_PERISH_SONG}
    },
    {
    .iv = 255,
    .lvl = 50,
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .species = SPECIES_DUSTOX,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SILVER_WIND, MOVE_TOXIC, MOVE_LIGHT_SCREEN, MOVE_SLUDGE_BOMB}
    },
    {
    .iv = 250,
    .lvl = 52,
    .species = SPECIES_MUK,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_CURSE, MOVE_BRICK_BREAK, MOVE_SHADOW_BALL}
    },
    {
    .iv = 250,
    .lvl = 53,
    .species = SPECIES_ROSELIA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LEECH_SEED, MOVE_PETAL_DANCE, MOVE_COTTON_SPORE, MOVE_SYNTHESIS}
    },
    {
    .iv = 250,
    .lvl = 51,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ENCORE, MOVE_YAWN, MOVE_SLUDGE_BOMB, MOVE_BODY_SLAM}
    },
    {
    .iv = 250,
    .lvl = 53,
    ...
    .species = SPECIES_SEVIPER,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_CRUNCH, MOVE_GLARE, MOVE_EARTHQUAKE, MOVE_POISON_FANG}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_TOMB, MOVE_DRAGON_BREATH, MOVE_DOUBLE_EDGE, MOVE_IRON_TAIL}
    },
    {
    .iv = 250,
    .lvl = 55,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER, MOVE_DRAGON_BREATH, MOVE_RAIN_DANCE, MOVE_COTTON_SPORE}
    },
    {
    .iv = 250,
    .lvl = 54,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_HARDEN, MOVE_BUBBLE, MOVE_ROCK_TOMB}
    },
    {
    .iv = 200,
    .lvl = 15,
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .species = SPECIES_LOUDRED,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUPERSONIC, MOVE_EXTRASENSORY, MOVE_FACADE, MOVE_HOWL}
    },
    {
    .iv = 200,
    .lvl = 30,
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .species = SPECIES_MASQUERAIN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYDRO_PUMP, MOVE_PSYBEAM, MOVE_SIGNAL_BEAM, MOVE_AERIAL_ACE}
    },
    {
    .iv = 210,
    .lvl = 31,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .species = SPECIES_GRUMPIG,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_THUNDER_PUNCH, MOVE_CONFUSE_RAY, MOVE_CALM_MIND}
    },
    {
    .iv = 250,
    .lvl = 42,
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_SPIKES, MOVE_ICE_BEAM, MOVE_HAIL}
    },
    {
    .iv = 200,
    .lvl = 41,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HAIL, MOVE_WATER_PULSE, MOVE_WEATHER_BALL, MOVE_FLAMETHROWER}
    },
    {
    .iv = 200,
    .lvl = 43,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_ICE_PUNCH, MOVE_FAKE_TEARS, MOVE_WISH}
    },
    {
    .iv = 200,
    .lvl = 43,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICICLE_SPEAR, MOVE_ROCK_SLIDE, MOVE_MUD_SHOT, MOVE_BODY_SLAM}
    },
    {
    .iv = 250,
    .lvl = 46,
    ...
    .moves = {MOVE_WATER_PULSE, MOVE_BLIZZARD, MOVE_SNORE, MOVE_REST}
    }
};
