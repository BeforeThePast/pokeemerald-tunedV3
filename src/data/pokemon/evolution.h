const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_METAPOD]    = {{EVO_LEVEL, 14, SPECIES_BUTTERFREE}},
    [SPECIES_WEEDLE]     = {{EVO_LEVEL,  7, SPECIES_KAKUNA}},
    [SPECIES_KAKUNA]     = {{EVO_LEVEL, 14, SPECIES_BEEDRILL}},
    ...
    [SPECIES_SPEAROW]    = {{EVO_LEVEL, 26, SPECIES_FEAROW}},
    ...
    [SPECIES_VENONAT]    = {{EVO_LEVEL, 30, SPECIES_VENOMOTH}},
    ...
    [SPECIES_ABRA]       = {{EVO_LEVEL, 18, SPECIES_KADABRA}},
    [SPECIES_KADABRA]    = {{EVO_LEVEL, 35, SPECIES_ALAKAZAM}},
    ...
    [SPECIES_HAUNTER]    = {{EVO_LEVEL, 37, SPECIES_GENGAR}},
    ...
    [SPECIES_KOFFING]    = {{EVO_LEVEL, 32, SPECIES_WEEZING}},
    [SPECIES_RHYHORN]    = {{EVO_LEVEL, 38, SPECIES_RHYDON}},
    [SPECIES_CHANSEY]    = {{EVO_FRIENDSHIP, 0, SPECIES_BLISSEY}},
    [SPECIES_HORSEA]     = {{EVO_LEVEL, 28, SPECIES_SEADRA}},
    ...
    [SPECIES_OMANYTE]    = {{EVO_LEVEL, 36, SPECIES_OMASTAR}},
    [SPECIES_KABUTO]     = {{EVO_LEVEL, 36, SPECIES_KABUTOPS}},
    [SPECIES_DRATINI]    = {{EVO_LEVEL, 28, SPECIES_DRAGONAIR}},
    ...
    [SPECIES_FEEBAS]     = {{EVO_LEVEL, 34, SPECIES_MILOTIC}},
    [SPECIES_CARVANHA]   = {{EVO_LEVEL, 30, SPECIES_SHARPEDO}},
    [SPECIES_TRAPINCH]   = {{EVO_LEVEL, 28, SPECIES_VIBRAVA}},
    [SPECIES_VIBRAVA]    = {{EVO_LEVEL, 40, SPECIES_FLYGON}},
    [SPECIES_MAKUHITA]   = {{EVO_LEVEL, 26, SPECIES_HARIYAMA}},
    [SPECIES_ELECTRIKE]  = {{EVO_LEVEL, 27, SPECIES_MANECTRIC}},
    ...
    [SPECIES_SHUPPET]    = {{EVO_LEVEL, 34, SPECIES_BANETTE}},
    [SPECIES_ARON]       = {{EVO_LEVEL, 27, SPECIES_LAIRON}},
